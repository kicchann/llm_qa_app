...
abstract class $SignInStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({String email, String password, bool isObscure});
}
...
class _$_SignInState with DiagnosticableTreeMixin implements _SignInState {
  const _$_SignInState(
      {this.email = '', this.password = '', this.isObscure = true});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'SignInState(email: $email, password: $password, isObscure: $isObscure)';
  }
...
abstract class _SignInState implements SignInState {
  const factory _SignInState(
      {final String email,
      final String password,
      final bool isObscure}) = _$_SignInState;
